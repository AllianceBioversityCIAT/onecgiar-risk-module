...
import { EmailBodyDialogComponent } from 'src/app/components/email-body-dialog/email-body-dialog.component';
import { FilterService } from 'src/app/components/filter.service';
...
export class EmailsComponent implements OnInit {
  ...
  openShowEmailBodyDialog(data: any): void {
    const dialogRef = this.dialog.open(EmailBodyDialogComponent, {
      width: '700px',
      data: data,
    });
